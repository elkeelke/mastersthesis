---
title: Biodiversity footprinting for the renewable energy sector
...
The title of the master's thesis is: *Biodiversity footprinting for the renewable energy sector: A high-level assessment of renewable energy infrastructure impacts on biodiversity globally and in Switzerland using a life cycle assessment (LCA) approach*

## Research aim and contribution

LCA in the energy sector often focuses primarily on impacts related to climate change. This thesis seeks to broaden that by incorporating the biodiversity impacts associated with renewable energy production infrastructure on national and global scales. 

## Gap analysis

The literature review presented in @sec-literature-study indicates that established methods for biodiversity LCA are available. However, their application to renewable energy systems remains limited in scope and consistency. Recent work by Gong et al. (2025) addresses biodiversity impacts from renewable energy infrastructure based on a spatially aware approach, but with a different objective and methodological approach. Their study focuses on quantifying the financial implications of biodiversity loss and employs Threat-Abatement STAR (STAR$_T$) scores, which estimate the potential reduction in species extinction risk through threat mitigation. Although this provides valuable insights into conservation prioritization, it does not perform an LCA. Consequently, a gap remains in applying established biodiversity LCA methodologies to assess the impacts of renewable energy infrastructure.
...
The first research question is defined as follows: How do biodiversity footprints differ across energy production technologies when measured per unit of electricity produced, and which factors drive these differences? There are three hypotheses proposed: 

1.   Wind energy has the lowest biodiversity impact per megawatt hour (MWh) produced because it has the lowest direct land use and is often sited in already modified landscapes. <!-- One key caveat is the localized impacts on birds and bats. -->

1.   Solar energy has a moderate biodiversity impact per MWh produced since it requires larger continuous land areas than wind which are often located in lower-biodiversity regions such as deserts or mountain plateaus. <!-- Impact depends strongly on prior land use and habitat sensitivity -->

1.   Hydro energy has the highest biodiversity impact per MWh produced since it causes significant land transformation and habitat fragmentation, alters river ecosystems and flow regimes, and is frequently located in biodiversity-rich regions such as river basins.

The second research question examines how direct and indirect impacts compare. The functional unit again is one MWh produced by the energy plant. The hypotheses are:

1.  Indirect biodiversity impacts from energy plant infrastructure and material production exceed direct impacts for most energy technologies driven by resource extraction, material processing, and manufacturing processes that occur across global supply chains.

1.  The relative contribution of direct impacts varies significantly across energy technologies. Technologies with large physical footprints such as hydro energy are expected to have higher direct impacts compared to technologies with complex material inputs such as solar panels, which may have proportionally higher indirect impacts.

1.  Direct biodiversity impacts are highly dependent on the regional ecological context and strongly dependent on the biodiversity that exists on the land before it gets converted.

The time plan outlined in @sec-timeplan indicates that it will be possible to address the two primary research questions within the scope of this project. 

If progress is faster than anticipated, a third research question will be explored: How do the biodiversity footprints of renewable and non-renewable energy production differ? The hypothesis is that renewable energy production has a significantly smaller footprint per MWh produced compared to non-renewable technologies. To ensure a fair comparison, emissions and land use associated with feedstock (such as coal production areas) for non-renewable energy production will be included, in addition to the land use of the plant itself.

<!--
Can we include threat to birds in the calculation somehow?
...
### LCA methodology {#sec-lca-methodology} 

Two methodologies will be employed. One main building block will be the work by @scherer2023biodiversity which provides a set of characterization factors for assessing the impact of land use on terrestrial biodiversity as part of the Global Life Cycle Impact Assessment Method (GLAM). This approach considers land use intensities and habitat fragmentation at a global scale. The other one will be LC-Impact created by @verones2020lc, which is a method that considers climate change, photochemical ozone formation, terrestrial acidification, terrestrial ecotoxicity, and land stress for terrestrial ecosystems. To achieve the most accurate results for land stress, the LC-IMPACT factors can be overwritten with the more recent and detailed GLAM characterization factors for land use.
...
In addition to the data already described in @sec-lca-methodology the following datasets are also required:

-   Several datasets for energy infrastructure locations exist. As tracked in task 25 in @fig-timeplan, the relevant selection criteria will be defined and the best data source will be selected according to these criteria.  <!-- Renewable Energy infrastructure locations: @Gong2025 used the S&P Global Market Intelligence (S&P MI) database which provides detailed data on over 100.000 global power plants which is a commercial product that might potentially be available for research purposes. Open source alternatives exists, e.g. the ResourceWatch Global Power Plant Database https://resourcewatch.org/data/explore/Powerwatch or the Global energy monitor https://globalenergymonitor.org/ and several research papers such as @kruitwagen2021global who identified nearly 70.000 PV plants or @zeng2025global who provide yearly data about PV plant locations from 2019 to 2025. -->
-   The Ecoregions dataset created by @dinerstein2017ecoregion and available under a CC-BY-4.0 license online from @dinerstein2017ecoregion_resolve will be used to assign ecological classifications to geographic coordinates. <!--(as Shape file and in Earth Engine) -->
...
The expected outcome is a thesis in scientific paper format with approximately 15 pages. The paper will contain analysis results that answer the research question and show the total impact on biodiversity from renewable energy infrastructure, a comparison between direct and indirect impacts, and breakdowns for solar, wind, and hydro power as well as breakdowns at the country level, in particular for Switzerland.

The following results are optional:

* Comparison of renewable to non-renewable energy production biodiversity footprints (see research question 3)
* Paper publication
* Open source implementation of LC-IMPACT on GitHub (or similar) supporting regional analysis

## Work plan and project schedule {#sec-timeplan}

![Project schedule](img/timeplan.png){#fig-timeplan fig-align="center" width="100%"}

The project schedule with planned tasks and their start and end dates is shown in @fig-timeplan. Note that the tasks are expected to overlap more than shown in the selected dates. The initial purpose of the plan was to work out how many of the research questions can be tackled in the given time frame. During project execution, the time plan will be used for tracking progress and will be updated during the project. The latest version of this plan is available [here](https://docs.google.com/spreadsheets/d/1_QHeDnfFwLujNv_Hiss8qOS5SjA5-003iTmxzy1sRdA/edit?gid=1314943303#gid=1314943303).

## Risk assessment

There were no major risks identified that could stall project progress. Tasks that may not be feasible within the given timeframe were designated as optional. The most challenging aspect of the project will be finding a reliable method to approximate renewable energy plant sizes, as the accuracy of this estimation will greatly affect the results of the biodiversity LCA.

On a broader level, there is a risk that the work could be taken out of context and used as an argument against renewable energy. This can be mitigated by clearly stating in the abstract that renewable energy is critical for climate mitigation, as well as by the findings related to the third research question.

## Budget plan

If the paper is accepted for publication at a conference, a budget for conference travel will be required. Estimated costs amount to ca. EUR 250 for travel and ca. EUR 500 for accommodation, assuming the conference takes place within Europe. The trip will either be self-funded, or suitable external funding sources will be identified.

## Literature study: current state of research {#sec-literature-study}

This chapter reviews literature about methodologies for biodiversity LCA in @sec-literature-study-bio-LCA, biodiversity and spatial data in @sec-literature-study-bio-spatial, and analyses of the effects of energy production on biodiversity in @sec-literature-study-bio-energy. The latter two sections include a review of notable case studies in the respective fields.

### Methodologies for biodiversity LCA {#sec-literature-study-bio-LCA}
...
@damiani2023critical provide a more recent review of 64 biodiversity assessment methods applied in LCA, without including Threat-Abatement STAR (STAR$_T$) scores. They conclude that no single method currently captures all the environmental pressures, ecosystems, taxonomic groups, and Essential Biodiversity Variable (EBV) classes. Marine ecosystems, invasive species, and genetic diversity are frequently excluded. The authors stress the importance of integrating ecosystem services and a wider range of direct drivers of biodiversity loss.
...
### Biodiversity and spatial data {#sec-literature-study-bio-spatial}
...
### Analysis of the effects of energy production on biodiversity {#sec-literature-study-bio-energy}
