...
The second research question is related to the question of how direct and indirect impacts compare. The functional unit again is one MWh produced by the energy plant. The hypotheses are:
...
There will be two methodologies employed. One main building block will be the work by @scherer2023biodiversity which provides a set of characterization factors for assessing the impact of land use on terrestrial biodiversity as part of the Global Life Cycle Impact Assessment Method (GLAM). This approach considers land use intensities and habitat fragmentation at a global scale. The other one will be LC-Impact created by @verones2020lc, which is a method that considers climate change, photochemical ozone formation, terrestrial acidification, terrestrial ecotoxicity, and land stress for terrestrial ecosystems. To achieve the most accurate results for land stress, the LC-IMPACT factors can be overwritten with the more recent and detailed GLAM characterization factors for land use.
...
The expected outcome is a thesis in scientific paper format with approximately 15 pages. The paper will contain analysis results that answer the research question and show the total impact on biodiversity from renewable energy infrastructure, a comparison between direct and indirect impacts, and breakdowns for solar, wind, and hydro power as well as breakdowns on the country level, in particular for Switzerland.
...
There were no major risks identified that could stall project progress. Tasks that might not be possible to complete within the project time frame were marked as optional. The most challenging aspect of the project will be finding a reliable method to approximate renewable energy plant sizes, as the accuracy of this estimation will greatly affect the results of the biodiversity LCA.
...
@damiani2023critical provide a more recent review.
