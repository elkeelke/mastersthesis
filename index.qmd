...
The work will focus on life cycle assessment (LCA) since it is carried out within the LCA research group, and will include a remote sensing part as well as an energy related part.

## Research aims

The goals for this project are as follows:

-   Understand and document the state of the art for biodiversity related LCA indicators
-   Assess state of the art for LCA indicators in use in the energy sector
-   Investigate potential of remote sensing data as a data base for biodiversity related LCA indicators in the energy sector
-   Provide demonstrator / prototype / analysis based on existing data, and an approach for how it can build the base for a high-level assessment for CH and globally
...
Options for high-level assessment demonstrator / prototype / analysis:
...
The gaps identified in the field of research will be one of the outcomes of the full literature study. See @sec-literature-study for the preliminary work.

### Motivation for the research

Existing LCA in the energy sector most focus on the climate change impact category. The motivation for the research is to expand the LCA to all biodiversity related impact categories to provide a full picture of the environmental impact of the energy sector as well as better ways to compare the different means of energy production against each other.

### Justification of the added scientific value for the field of study

The work will provide methodological innovation for LCA methods via remote sensing integration.
...
-   High-level assessment demonstrator / prototype / analysis based on existing data
...
For the work itself there is a risk that remote sensing data turns out to be not useful for the planned task.
