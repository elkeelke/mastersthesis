...
1.  Direct biodiversity impacts are highly dependent on the regional ecological context and strongly dependent on the biodiversity that exists on the land that before it gets converted.

The time plan outlined in @sec-timeplan indicates that it will be possible to address the two primary research questions within the scope of this project. If progress is faster than anticipated, a third research question will be explored: How do the biodiversity footprints for renewable energy and non-renewable energy production differ? The hypothesis for this question is that renewable energy production has a significantly smaller footprint per MWh produced compared to non-renewable technologies.
...
There will be two methodologies employed. One main building block will be the work by @scherer2023biodiversity which provides a set of characterization factors for assessing the impact of land use on terrestrial biodiversity as part of the Global Life Cycle Impact Assessment Method (GLAM). This approach considers land use intensities and habitat fragmentation at a global scale. The other one will be be LC-Impact created by @verones2020lc, which is a method that considers climate change, photochemical ozone formation, terrestrial acidification, terrestrial ecotoxicity, and land stress for terrestrial ecosystems. To achieve the most accurate results for land stress, the LC-IMPACT factors can be overwritten with the more recent and detailed GLAM characterisation factors for land use.
...
The expected outcome is a thesis in scientific paper format with approximately 15 pages. The paper will contain analysis results that answer the research question and show the total impact on biodiversity from renewable energy infrastructure, a comparison between direct and indirect impacts, and breakdowns for solar, wind, and hydro power.
...
The projected project schedule is pictured in @fig-timeplan. Note that the task are expected to overlap much more than shown in the selected dates. The initial goal of the plan was to work out how many of the research questions can be tackled in the given time frame. The time plan will be updated to track progress during the project. The latest version of this plan can always be found [here](https://docs.google.com/spreadsheets/d/1_QHeDnfFwLujNv_Hiss8qOS5SjA5-003iTmxzy1sRdA/edit?gid=1314943303#gid=1314943303).
