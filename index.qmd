...
-   Which existing biodiversity indicators are most relevant for the energy sector?
-   Which biodiversity indicators most relevant for the energy sector do not exist yet?
-   Which of these indicators (if any) can be evaluated using remote sensing data? While land use is possible to detect on satellite imagery for large plant, many other indicators might be hard to assess. Can you fly a drone over a certain site and detect presence or absence of wildlife?
...
In an ideal world this project can contribute to the development of new GLAM midpoint indicators (e.g. for alien species introductions, marine acidification, or functional diversity).
...
The project schedule is pictured in @fig-timeplan. Large tasks will be broken down into smaller ones.
