...
- What is the biodiversity level in the areas can RE plants mostly be found in? Hypothesis: PV plants are in areas with low biodiversity
...
-   Assess state of the art for LCA indicators and methods in use in the energy sector (optional ?)
-   Decide which data source to use for renewable energy plant locations
-   Decide which types of renewable energy plants can be supported
-   Design and implement data extraction
