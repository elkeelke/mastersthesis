...
1.   Wind energy has the lowest biodiversity impact per MWh generated because it has the lowest direct land use and is often sited in already modified landscapes. <!-- One key caveat is the localized impacts on birds and bats. -->

1.   Solar energy has a moderate biodiversity impact per MWh generated since it requires larger continuous land areas than wind which are often located in lower-biodiversity regions such as deserts or mountain. plateaus <!-- Impact depends strongly on prior land use and habitat sensitivity -->

1.   Hydro energy has the highest biodiversity impact per MWh generated since it causes significant land transformation and habitat fragmentation, alters river ecosystems and flow regimes, and is frequently located in biodiversity-rich regions such as river basins.

The second research question is related to the question of how direct and indirect impacts compare. The hypotheses are:
