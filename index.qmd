...
LCA in the energy sector often focuses primarily on impacts related to climate change. This thesis aims to extend this to the biodiversity impacts associated with energy production infrastructure on national and global scales. 

## Gap analysis

@Gong2025 provide an assessment of biodiversity impacts from renewable energy infrastructure. Their work aims to estimate the financial impact of the biodiversity loss from renewable energy infrastructure and is based in the Threat-Abatement STAR (STAR$_T$) scores, which quantify how much species extinction risk could be reduced if biodiversity threats were removed. This thesis focuses on assessing the full impacts on biodiversity based on the LCA methodologies GLAM and LC-Impact (see @sec-lca-methodology).
