...
-   Perform literature review of existing work
-   Understand state of the art for biodiversity related LCA indicators
-   Define exact research questions (see @sec-research-questions)
-   Investigate usage of satellite data for addressing the research questions

## Research questions and hypotheses {#sec-research-questions} 

Analysis of the effects of energy production on biodiversity

-   Which existing biodiversity indicators are most relevant for the energy sector? Hypothesis?
-   Are there any biodiversity indicators most relevant for the energy sector that do not exist yet? Hypothesis?
-   Which of these indicators (if any) can be evaluated using remote sensing data? The hypothesis is that while land use is possible to detect on satellite imagery for large energy plants, many other indicators will be hard to assess because much more fine-grained resolution than the satellite can provide is required. 


Can you fly a drone over a certain site and detect presence or absence of wildlife?

Options for demonstrator / prototype: 
...
@Deuber2026 states that many biodiversity relevant midpoint indicators (e.g. for alien species introductions, marine acidification, or functional diversity) do not yet exist. Out of these, functional diversity is relevant for the energy sector.
...
Ideally existing data can be used for this project:

- Use @Gong2025 data if they allow it and dive deep on one plant adding more indicators (paper did land use only) 
- Use foundation models, which are large-scale AI models pre-trained on large unlabeled Earth Observation data (satellite imagery, radar, weather) using self-supervised learning. They provide versatile embeddings which are numerical representations of each pixel that can be employed for any task that relies on similarities between land cover.

## Expected results

The following outcome is expected:

-   Provide some kind of demonstrator or prototype
-   Write a thesis in scientific paper format with approximately 15 pages
