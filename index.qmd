...
LCA in the energy sector often focuses primarily on impacts related to climate change. This thesis aims to contribute to a more comprehensive understanding of the land use impacts associated with energy production infrastructure on national and global scales using remote sensing data.

The contribution is to provide estimates for the land use of renewable energy production plants using a novel approach for this use case.

## Research questions and hypotheses {#sec-research-questions}

- Which areas can RE plants mostly be found? Hypothesis: PV plants are in areas with low biodiversity
...
While land use from renewable energy infrastructure has been assessed using Threat-Abatement STAR (STAR$_T$) score, it has not been evaluated using LC-Impact.

Further gaps that might be worth looking at:

-   Biodiversity impact except from land use
...
-   Habitat Restoration STAR (STAR$_R$) score estimates the potential reduction in a species' extinction risk that could be achieved by restoring lost habitat
...
The main metric used will be LC-Impact (TBD describe). If possible, the results will be cross checked against the results from @Gong2025 which is based on spatial Threat-Abatement STAR (STAR$_T$) scores introduced by @mair2021metric.

### Spatial and remote sensing data

Describe existing data can be used for this project:

-   Ecoregions defined by @dinerstein2017ecoregion and available under a CC-BY-4.0 license online from @dinerstein2017ecoregion_resolve (as Shape file and in Earth Engine)
-   Renewable Energy infrastructure: TBD Find out if same data as in @Gong2025 can be used (likely yes)
...
The work items for this project are as follows:

-   Assess state of the art for LCA indicators and methods in use in the energy sector
-   Understand and document the state of the art for land use related LCA indicators and methods
-   TBD
