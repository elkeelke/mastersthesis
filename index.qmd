...
LCA in the energy sector often focuses primarily on impacts related to climate change and land use. This thesis aims to contribute to a more comprehensive understanding of the full range of biodiversity impacts associated with energy production infrastructure at the national or global scale.
...
-   Identify certain types of large energy infrastructure (e.g., reservoir dams) or side effect caused by energy production related activities (e.g., oil spills, methane leaks, coal mining pit lakes) where effects on biodiversity are currently underrepresented in LCA because of missing data and/methods
-   Investigate the potential of remote sensing data to provide data for these type of energy infrastructure and side effects
-   Provide a generalization for how that data can be employed for improving inventory regionalization of biodiversity related LCA indicators
