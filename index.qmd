...
LCAs in the energy sector often focus primarily on impacts related to climate change and land use. This thesis aims to contribute to a more comprehensive understanding of the full range of biodiversity impacts associated with energy production infrastructure at the national or global scale.

## Research questions and hypotheses {#sec-research-questions}

The goals for this project are as follows:

-   Assess state of the art for LCA indicators and methods in use in the energy sector
-   Understand and document the state of the art for biodiversity related LCA indicators and methods
-   
-   Investigate the potential of remote sensing data to provide inventory regionalization for biodiversity related LCA indicators in the energy sector
...
-   Assess Infrastructure Losses (escaping gas), Kohleabbau (Polen) creates Baggersee, 
-   Methane detection
-   Case study for some Swiss energy plant? Can't be done on satellite. Would flying a drone over it even be allowed?
...
Provide a description of the relevant biodiversity LCA indicators and methods.
...
-   Case study / demonstrator / prototype / analysis (TBD) together with a description for how it can build the base for a high-level assessment for CH and globally
...
For the research goals, there is a risk that remote sensing data turns out to be not useful for the planned task. TBD: How to mitigate?
