...
The literature study performed in @sec-literature-study revealed that established methods for biodiversity LCA exist. The methodology described in @sec-lca-methodology will be applied. While an assessment of biodiversity impacts from renewable energy infrastructure has already been performed by @Gong2025, their work has a different focus because it aims to estimate the financial impact of the biodiversity loss from renewable energy infrastructure. In this work, the biodiversity loss is estimated using the Threat-Abatement STAR (STAR$_T$) scores, which quantify how much species extinction risk could be reduced if biodiversity threats were removed, instead of using LCA methodology which is what will be performed in the thesis. 
